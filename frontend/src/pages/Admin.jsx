...
const Admin = () => {
  ...
  if (!token) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-primary pt-40">
        <SEO title="Admin Login" description="Elite Engineers Admin Login" />
        <div className="bg-white dark:bg-secondary p-12 shadow-2xl max-w-md w-full border border-gray-200 dark:border-gray-800">
          <h2 className="text-3xl font-display uppercase tracking-widest text-center mb-8 text-gray-900 dark:text-white">Admin Login</h2>
          <form onSubmit={handleLogin}>
            ...
            <button type="submit" className="w-full py-3 bg-accent text-white text-xs tracking-widest uppercase hover:bg-black transition-colors duration-300">
              Login
            </button>
          </form>
        </div>
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-primary pt-24 pb-24 text-gray-900 dark:text-white">
      ...
      <div className="max-w-[1400px] mx-auto px-4 mt-8 flex flex-col md:flex-row gap-8">
        ...
        <div className="w-full md:w-64 shrink-0">
          <div className="bg-white dark:bg-secondary border border-gray-200 dark:border-gray-800 p-6 shadow-sm sticky top-32">
            <h1 className="text-xl font-display uppercase tracking-widest mb-8 border-b border-gray-200 dark:border-gray-800 pb-4 text-gray-900 dark:text-white">Dashboard</h1>
            ...
            <button 
              ...
              className="w-full mt-12 text-xs text-red-400 uppercase tracking-widest hover:text-gray-900 dark:text-white py-3 px-4 border border-red-900/40 hover:bg-red-600 hover:border-red-600 transition-all duration-200"
            >
              Logout
            </button>
          </div>
